...
coder='Monir';team='';git='Md-Monir-Hossen';tg='https://www.facebook.com/mdmonirhossen62'
credit={"Tool": tool, "Monir": coder, "Follow-Facebook": team, "Facebook": git, "Command_Lagle_Inbox": gift};go='xdg-open '
...
def DARK_TEAM_LMNx9():
    ...
    lmnx9_banner()
    lmnx9("[blue][[red]>[blue]][bold red] King_On_Monir [bold yellow]Unlimited "+running)
    lmnx9(47*f'[bold cyan]-'+'[bold white]')
